...
const ProductCard = ({ title, description, href, index, tag = "Game" }: ProductCardProps) => {
  return (
    <motion.a
      href={href}
      className="group relative block rounded-[15px] border border-border bg-card p-8 md:p-10 transition-all duration-300 hover:bg-foreground hover:border-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-foreground focus-visible:ring-offset-4 focus-visible:ring-offset-background"
